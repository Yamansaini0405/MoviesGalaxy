      ...
      try {
        ...
        while (currPage <= 8) {
          const response = await fetch(
            `https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=${currPage}&api_key=79218d83e67c13cb59242f9f31418607`
      ...
      <div>
        {info.loading ? (
          ...
          <div className="flex flex-wrap  lg:px-4 ">
            ...
            <h3 className="text-white text-2xl md:text-4xl mt-7 ml-2 font-bold text-[#00FFFF]">
              Upcoming Movies
            </h3>
